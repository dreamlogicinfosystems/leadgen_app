...
import '../add_lead/open_lead.dart';

class PastLeadsBody extends StatefulWidget {
  const PastLeadsBody({super.key});

  @override
  State<PastLeadsBody> createState() => _PastLeadsBodyState();
}

class _PastLeadsBodyState extends State<PastLeadsBody> {
  ...
  @override
  void initState() {
    context.read<LeadBloc>().add(LeadEvent.getLeads('close', 0, context));
    super.initState();
  }
        ...
        return state.maybeWhen(
            ...
            emptyLeadList: (error){
              return SizedBox(
                ...
                height: MediaQuery.of(context).size.height*0.8,
                child: Center(
                  child: Text('No past leads',style: GoogleFonts.poppins(fontWeight: FontWeight.w500,fontSize: 16)),
                ),
              );
            },
